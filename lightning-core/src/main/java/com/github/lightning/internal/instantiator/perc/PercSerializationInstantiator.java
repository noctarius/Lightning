 ...
 * under the License.
 */
package com.github.lightning.internal.instantiator.perc;
 ...
 * only supposed to
 * work on Perc JVMs. This instantiator will create classes in a way compatible
 * with serialization,
...
public class PercSerializationInstantiator implements ObjectInstantiator {
	...
	public PercSerializationInstantiator(Class<?> type) {
		...
		try {
			...
			newInstanceMethod = ObjectInputStream.class.getDeclaredMethod("noArgConstruct", new Class[] { Class.class, Object.class, percMethodClass });
