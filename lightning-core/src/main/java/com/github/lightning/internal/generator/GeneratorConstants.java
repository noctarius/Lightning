...
public interface GeneratorConstants {
	...
	static String MARSHALLER_IS_ALREADY_MARSHALLED_SIGNATURE = Type.getMethodDescriptor(Type.BOOLEAN_TYPE,
			new Type[] { Type.getType(Object.class), Type.getType(Class.class), Type.getType(DataOutput.class), Type.getType(SerializationContext.class) });

	static String MARSHALLER_CONSTRUCTOR_SIGNATURE = Type.getMethodDescriptor(
			Type.VOID_TYPE,
			new Type[] { Type.getType(Class.class), Type.getType(Map.class), Type.getType(ClassDescriptorAwareSerializer.class),
					Type.getType(ObjectInstantiatorFactory.class), Type.getType(List.class), Type.getType(MarshallerStrategy.class) });

	static String MARSHALLER_SUPER_CONSTRUCTOR_SIGNATURE = Type.getMethodDescriptor(
			Type.VOID_TYPE,
			new Type[] { Type.getType(Class.class), Type.getType(Map.class), Type.getType(ClassDescriptorAwareSerializer.class),
	...
	static String PROPERTY_ACCESSOR_READ_BOOLEAN_SIGNATURE = Type.getMethodDescriptor(Type.BOOLEAN_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_BYTE_SIGNATURE = Type.getMethodDescriptor(Type.BYTE_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_CHAR_SIGNATURE = Type.getMethodDescriptor(Type.CHAR_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_SHORT_SIGNATURE = Type.getMethodDescriptor(Type.SHORT_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_INT_SIGNATURE = Type.getMethodDescriptor(Type.INT_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_LONG_SIGNATURE = Type.getMethodDescriptor(Type.LONG_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_FLOAT_SIGNATURE = Type.getMethodDescriptor(Type.FLOAT_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_DOUBLE_SIGNATURE = Type.getMethodDescriptor(Type.DOUBLE_TYPE, new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_READ_OBJECT_SIGNATURE = Type.getMethodDescriptor(Type.getType(Object.class), new Type[] { Type.getType(Object.class) });

	static String PROPERTY_ACCESSOR_WRITE_BOOLEAN_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.BOOLEAN_TYPE });

	static String PROPERTY_ACCESSOR_WRITE_BYTE_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class), Type.BYTE_TYPE });

	static String PROPERTY_ACCESSOR_WRITE_CHAR_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class), Type.CHAR_TYPE });

	static String PROPERTY_ACCESSOR_WRITE_SHORT_SIGNATURE = Type
			.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class), Type.SHORT_TYPE });

	static String PROPERTY_ACCESSOR_WRITE_INT_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class), Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_WRITE_LONG_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class), Type.LONG_TYPE });

	static String PROPERTY_ACCESSOR_WRITE_FLOAT_SIGNATURE = Type
			.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class), Type.FLOAT_TYPE });
	...
	static String PROPERTY_ACCESSOR_ARRAY_READ_BOOLEAN_SIGNATURE = Type.getMethodDescriptor(Type.BOOLEAN_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE });
	...
	static String PROPERTY_ACCESSOR_ARRAY_READ_SHORT_SIGNATURE = Type.getMethodDescriptor(Type.SHORT_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_READ_INT_SIGNATURE = Type
			.getMethodDescriptor(Type.INT_TYPE, new Type[] { Type.getType(Object.class), Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_READ_LONG_SIGNATURE = Type.getMethodDescriptor(Type.LONG_TYPE,
			new Type[] { Type.getType(Object.class), Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_READ_FLOAT_SIGNATURE = Type.getMethodDescriptor(Type.FLOAT_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_READ_DOUBLE_SIGNATURE = Type.getMethodDescriptor(Type.DOUBLE_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_READ_OBJECT_SIGNATURE = Type.getMethodDescriptor(Type.getType(Object.class), new Type[] { Type.getType(Object.class),
			Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_BOOLEAN_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.BOOLEAN_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_BYTE_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.BYTE_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_CHAR_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.CHAR_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_SHORT_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.SHORT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_INT_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.INT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_LONG_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.LONG_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_FLOAT_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.FLOAT_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_DOUBLE_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
			Type.INT_TYPE, Type.DOUBLE_TYPE });

	static String PROPERTY_ACCESSOR_ARRAY_WRITE_OBJECT_SIGNATURE = Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { Type.getType(Object.class),
