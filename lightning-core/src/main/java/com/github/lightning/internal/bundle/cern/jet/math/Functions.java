 ...
 */
package com.github.lightning.internal.bundle.cern.jet.math;

import com.github.lightning.internal.bundle.cern.colt.function.DoubleDoubleFunction;
import com.github.lightning.internal.bundle.cern.colt.function.DoubleDoubleProcedure;
import com.github.lightning.internal.bundle.cern.colt.function.DoubleFunction;
import com.github.lightning.internal.bundle.cern.colt.function.DoubleProcedure;
 ...
 * {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleFunction}
 * , binary functions of type
 * {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleDoubleFunction}
 * . All can be retrieved via <tt>public 
  static final</tt> variables named after the
 * function. Unary predicates are of type
 * {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleProcedure}
 * , binary predicates of type
 * {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleDoubleProcedure}
 * . All can be retrieved via <tt>public 
...
public class Functions extends Object {
	 ...
	 * (argument) fixed to the given constant <tt>c</tt>.
	 ...
	 * operand (argument) fixed to the given constant <tt>c</tt>.
	...
	public static void demo1() {
		com.github.lightning.internal.bundle.cern.jet.math.Functions F = com.github.lightning.internal.bundle.cern.jet.math.Functions.functions;
		double a = 0.5;
		double b = 0.2;
		double v = Math.sin(a) + Math.pow(Math.cos(b), 2);
		System.out.println(v);
		...
		System.out.println(g.apply(a, b));
		DoubleFunction m = Functions.plus(3);
		DoubleFunction n = Functions.plus(4);
	...
	public static void demo2(int size) {
		...
		DoubleDoubleFunction f = Functions.chain(Functions.abs, Functions.chain(Functions.plus, Functions.sin, Functions.chain(Functions.square, Functions.cos)));
		...
		// emptyLoop
		com.github.lightning.internal.bundle.cern.colt.Timer emptyLoop = new com.github.lightning.internal.bundle.cern.colt.Timer().start();
		a = 0;
		b = 0;
		double sum = 0;
		for (int i = size; --i >= 0;) {
		...
		com.github.lightning.internal.bundle.cern.colt.Timer timer = new com.github.lightning.internal.bundle.cern.colt.Timer().start();
		a = 0;
		b = 0;
		sum = 0;
		for (int i = size; --i >= 0;) {
	...
	public static DoubleDoubleFunction plusMult(double constant) {
		...
		/*
		 * return new DoubleDoubleFunction() {
		 * public final double apply(double a, double b) { return a +
		 * b*constant; }
		 * };
		 */
	}
	 ...
	 * {@link com.github.lightning.internal.bundle.cern.jet.random.engine.MersenneTwister}
	 * and is seeded with the current time.
	 * <p>
	 * Note that any random engine derived from
	 * {@link com.github.lightning.internal.bundle.cern.jet.random.engine.RandomEngine}
	 * and any random distribution derived from
	 * {@link com.github.lightning.internal.bundle.cern.jet.random.AbstractDistribution}
	 * are function objects, because they implement the proper interfaces. Thus,
	 * if you are not happy with the default, just pass your favourite random
	 * generator to function evaluating methods.
	 */
	public static DoubleFunction random() {
		return new com.github.lightning.internal.bundle.cern.jet.random.engine.MersenneTwister(new java.util.Date());
	}

	/**
	 * Constructs a function that returns the number rounded to the given
	 * precision; <tt>Math.rint(a/precision)*precision</tt>.
	 * Examples:
	 * 
	 * <pre>
