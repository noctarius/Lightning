 ...
 */
public abstract class AbstractMap extends com.github.lightning.internal.bundle.cern.colt.PersistentObject {
	 ...
	 * The term "c * minLoadFactor" is called the "lowWaterMark",
	 * "c * maxLoadFactor" is called the "highWaterMark".
	 * In other words, the table capacity (and proportionally the memory used by
	 * this class) oscillates within these constraints.
	 * The terms are precomputed and cached to avoid recalculating them each
	 * time put(..) or removeKey(...) is called.
	 */
	 ...
	 * You will almost certainly need to override this method in subclasses to
