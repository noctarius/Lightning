...
import com.github.lightning.internal.bundle.cern.jet.random.engine.RandomEngine;
 ...
 * is recommended as uniform pseudo-random number generation engine, since it is
 * very strong and at the same time quick. {@link #makeDefaultGenerator()} will
 * conveniently construct and return such a magic thing. You can also, for
 * example, use
 * {@link com.github.lightning.internal.bundle.cern.jet.random.engine.DRand}, a
 * quicker (but much weaker) uniform random number generation engine. Of course,
 * you can also use other strong uniform random number generation engines.
 * 
 * <p>
 ...
 * <p>
 * 
 * @see com.github.lightning.internal.bundle.cern.jet.random.engine
 * @see com.github.lightning.internal.bundle.cern.jet.random.engine.Benchmark
 * @see cern.jet.random.Benchmark
 * @author wolfgang.hoschek@cern.ch
 * @version 1.0, 09/24/99
 */
public abstract class AbstractDistribution extends com.github.lightning.internal.bundle.cern.colt.PersistentObject implements
		com.github.lightning.internal.bundle.cern.colt.function.DoubleFunction, com.github.lightning.internal.bundle.cern.colt.function.IntFunction {
	 ...
	 * This has the effect that distributions can now be used as function
	...
	public static RandomEngine makeDefaultGenerator() {
		return com.github.lightning.internal.bundle.cern.jet.random.engine.RandomEngine.makeDefault();
	}
	 ...
	 * <tt>(int) Math.round(nextDouble())</tt>.
