...
public abstract class AbstractLongObjectMap<T> extends AbstractMap {
	 ...
	 * not, it it returns <tt>false</tt>. If so, it applies the iteration as
	 * described above.
	 * 
	 * @param obj
	 ...
	 * specified lists.
	 * Fills into the lists, starting at index 0.
	 * After this call returns the specified lists both have a new size that
	 * equals <tt>this.size()</tt>.
	 * <p>
	 * <b>Example:</b> <br>
	...
	public void pairsSortedByValue(final LongArrayList keyList, final ObjectArrayList valueList) {
		...
		com.github.lightning.internal.bundle.cern.colt.Swapper swapper = new com.github.lightning.internal.bundle.cern.colt.Swapper() {
		...
		com.github.lightning.internal.bundle.cern.colt.function.IntComparator comp = new com.github.lightning.internal.bundle.cern.colt.function.IntComparator() {
		...
		com.github.lightning.internal.bundle.cern.colt.GenericSorting.quickSort(0, keyList.size(), comp, swapper);
	}
	 ...
	 * the String representation of each key-value pair, sorted ascending by
	 * key.
	 */
	@Override
	 ...
	 * Returns a string representation of the receiver, containing
	 * the String representation of each key-value pair, sorted ascending by
	 * value, according to natural ordering.
	 */
