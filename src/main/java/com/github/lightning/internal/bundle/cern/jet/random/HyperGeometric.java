...
import com.github.lightning.internal.bundle.cern.jet.math.Arithmetic;
 ...
 * <tt>s</tt> is the probability distribution of the random variable X,
 * whose value is the number of successes in a sample of <tt>n</tt> items from a
