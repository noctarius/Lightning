...
public class EmpiricalWalker extends AbstractDiscreteDistribution {
	 ...
	 * The probability distribution function (pdf) is an array of positive real
	 * numbers.
	 * It need not be provided in the form of relative probabilities, absolute
	 * probabilities are also accepted.
