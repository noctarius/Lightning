...
if (numNegZeros != 0) {
	int j = new com.github.lightning.internal.bundle.cern.colt.list.DoubleArrayList(a).binarySearchFromTo(0.0d, fromIndex, n-1); // posn of ANY zero
	do {
		j--;
	} while (j>=0 && a[j]==0.0d);
...
// Postprocessing phase: change 0.0's to -0.0's as required
if (numNegZeros != 0) {
	int j = new com.github.lightning.internal.bundle.cern.colt.list.FloatArrayList(a).binarySearchFromTo(0.0f, fromIndex, n-1); // posn of ANY zero
	do {
		j--;
	} while (j>=0 && a[j]==0.0f);
