...
public void shuffleFromTo(int from, int to) {
	...
	com.github.lightning.internal.bundle.cern.jet.random.Uniform gen = new com.github.lightning.internal.bundle.cern.jet.random.Uniform(new com.github.lightning.internal.bundle.cern.jet.random.engine.DRand(new java.util.Date()));
	Object tmpElement;
	Object[] theElements = elements;
	int random;
	for (int i = from; i < to; i++) {
