...
<p>Unary functions are of type {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleFunction}, binary functions 
  of type {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleDoubleFunction}. All can be retrieved via <tt>public 
  static final</tt> variables named after the function. 
Unary predicates are of type {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleProcedure}, binary predicates 
  of type {@link com.github.lightning.internal.bundle.cern.colt.function.DoubleDoubleProcedure}. All can be retrieved via <tt>public 
 ...
 * Currently the engine is {@link com.github.lightning.internal.bundle.cern.jet.random.engine.MersenneTwister}
 * and is seeded with the current time.
 * <p>
 * Note that any random engine derived from {@link com.github.lightning.internal.bundle.cern.jet.random.engine.RandomEngine} and any random distribution derived from {@link com.github.lightning.internal.bundle.cern.jet.random.AbstractDistribution} are function objects, because they implement the proper interfaces.
