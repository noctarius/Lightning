 ...
 * <p>
 * {@link com.github.lightning.internal.bundle.cern.jet.random.engine.MersenneTwister} is recommended as uniform pseudo-random number generation engine, since it is very strong and at the same time quick.
 * {@link #makeDefaultGenerator()} will conveniently construct and return such a magic thing.
 * You can also, for example, use {@link com.github.lightning.internal.bundle.cern.jet.random.engine.DRand}, a quicker (but much weaker) uniform random number generation engine.
 ...
 */
public abstract class AbstractDistribution extends com.github.lightning.internal.bundle.cern.colt.PersistentObject implements com.github.lightning.internal.bundle.cern.colt.function.DoubleFunction, com.github.lightning.internal.bundle.cern.colt.function.IntFunction {
 ...
 * Currently this is {@link com.github.lightning.internal.bundle.cern.jet.random.engine.MersenneTwister}.
 */
