...
import com.github.lightning.internal.bundle.cern.colt.bitvector.BitVector;
import com.github.lightning.internal.bundle.cern.colt.bitvector.QuickBitVector;
 ...
 * implemented with a <tt>cern.colt.bitvector.BitVector</tt>.
 ...
 */
public class MinMaxNumberList extends com.github.lightning.internal.bundle.cern.colt.list.AbstractLongList {
	 ...
	 * specified range of values allowed to be hold in this list.
	...
	public static int bitsPerElement(long minimum, long maximum) {
		...
		if (1 + maximum - minimum > 0) {
			bits = (int) Math.round(Math.ceil(com.github.lightning.internal.bundle.cern.jet.math.Arithmetic.log(2, 1 + maximum - minimum)));
		}
		else {
	 ...
	 * <tt>partFrom</tt> within <tt>part</tt>.
	 * Elements are only copied if a corresponding flag within
	 ...
	 * and the specified range of values allowed to be hold in this list.
	 * Legal values are in the range [minimum,maximum], all inclusive.
	 * 
	 * @param minimum
	 *            the minimum of values allowed to be hold in this list.
	 ...
	 * WARNING: The bitvector and the receiver share the backing bits. Modifying
	 ...
	 * Remark: This does not mean that such a minimum element is currently
