 ...
 * types such as <code>int</code>, <code>float</code>, etc.
...
public abstract class AbstractList extends AbstractCollection {
	 ...
	 * If the new size is greater than the current size, new null or zero items
	 * are added to the end of the receiver.
	 * If the new size is less than the current size, all components at index
	 * newSize and greater are discarded.
	 * This method does not release any superfluos internal memory. Use method
	 * <tt>trimToSize</tt> to release superfluos internal memory.
	 * 
	 * @param newSize
	 ...
	 * Override <tt>sortFromTo(...)</tt> if you can determine which sort is most
	 ...
	 * Override this method if you can determine which sort is most appropriate
