 ...
 *
 *
 * @see com.github.lightning.internal.bundle.cern.jet.random
...
public static void benchmark(int times) {
	com.github.lightning.internal.bundle.cern.colt.Timer timer = new com.github.lightning.internal.bundle.cern.colt.Timer();
	RandomEngine gen;
