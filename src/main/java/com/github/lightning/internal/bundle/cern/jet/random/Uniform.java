...
/**
 * Constructs a uniform distribution with the given minimum and maximum, using a {@link com.github.lightning.internal.bundle.cern.jet.random.engine.MersenneTwister} seeded with the given seed.
 */
