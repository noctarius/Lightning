...
public void shuffleFromTo(int from, int to) {
	...
	com.github.lightning.internal.bundle.cern.jet.random.Uniform gen = new com.github.lightning.internal.bundle.cern.jet.random.Uniform(com.github.lightning.internal.bundle.cern.jet.random.Uniform.makeDefaultGenerator());
	for (int i=from; i<to; i++) { 
